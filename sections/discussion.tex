...
not merely tribal knowledge, and its higher reward variance highlights function
approximation pathologies rather than ambiguity about the optimum.

The sensitivity analysis in Section~\ref{subsec:sensitivity} adds engineering colour:
the heuristic sits on a flat optimum for low thresholds, stays robust at looser
thresholds, and still dominates PPO. Production teams may value that robustness,
